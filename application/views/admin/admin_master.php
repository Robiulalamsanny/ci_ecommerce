			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="<?php echo base_url()?>add-category"><i class="icon-edit"></i><span class="hidden-tablet"> Add Category</span></a></li>
						<li><a href="<?php echo base_url()?>manage-category"><i class="icon-tasks"></i><span class="hidden-tablet"> Manage Category</span></a></li>
						<li><a href="<?php echo base_url()?>add-manufacture"><i class="icon-edit"></i><span class="hidden-tablet"> Add manufacture</span></a></li>
						...
						<li><a href="<?php echo base_url()?>add-product"><i class="icon-edit"></i><span class="hidden-tablet">Add Product</span></a></li>
						<li><a href="<?php echo base_url()?>manage-product"><i class="icon-tasks"></i><span class="hidden-tablet">Manage Product</span></a></li>
						<li><a href="<?php echo base_url()?>manage-invoice"><i class="icon-tasks"></i><span class="hidden-tablet">Manage Invoice</span></a></li>
