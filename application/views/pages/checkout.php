<div class="accordion" id="accordion2">
							...
							<div class="accordion-group">
								<div class="accordion-heading">
									<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseTwo">Customer &amp;  Details</a>
								</div>
										...
										<div class="row-fluid">
											<div class="span6">
												...
												<div class="control-group">
													...
													<div class="controls">
														<input type="text" name="customer_first_name" placeholder="" class="input-xlarge">
													</div>
												</div>
												<div class="control-group">
													<label class="control-label">Last Name</label>
													<div class="controls">
														<input type="text"  name="customer_last_name" placeholder="" class="input-xlarge">
													</div>
												</div>					  
												<div class="control-group">
													<label class="control-label">Email Address</label>
													<div class="controls">
														<input type="text" name="customer_email_address" placeholder="" class="input-xlarge">
													</div>
												</div>
												...
												<div class="control-group">
													<label class="control-label">Password</label>
													<div class="controls">
														<input type="password" name="customer_password" placeholder="" class="input-xlarge">
													</div>
												</div>
												...
												<div class="control-group">
													...
													<div class="controls">
														<input type="text" name="customer_phone_number" placeholder="" class="input-xlarge">
													</div>
												</div>
												<div class="control-group">
													<label class="control-label">Adddress</label>
													<div class="controls">
														<input type="text" name="customer_address" placeholder="" class="input-xlarge">
													</div>
												</div>
